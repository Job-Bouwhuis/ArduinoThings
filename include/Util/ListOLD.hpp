...
//         template <typename U = T>
//         std::enable_if_t<!std::is_pointer<U>::value, std::shared_ptr<element_t>> Add(U &value)
//         {
//             EnsureCapacity(count + 1);
...
//         template <typename U = T>
//         std::enable_if_t<std::is_pointer<U>::value, std::shared_ptr<element_t>> Add(std::remove_pointer_t<U> *rawPtr)
//         {
//             EnsureCapacity(count + 1);
...
//         template <typename U = T>
//         std::enable_if_t<std::is_pointer<U>::value, std::shared_ptr<element_t>> Add(const element_t &value)
//         {
//             EnsureCapacity(count + 1);
//             data[count] = std::make_shared<element_t>(value);
//             ++count;
...
//         template <typename U = T>
//         std::enable_if_t<std::is_pointer<U>::value, std::shared_ptr<element_t>> Add(element_t &&value)
//         {
//             EnsureCapacity(count + 1);
//             data[count] = std::make_shared<element_t>(std::move(value));
//             ++count;
